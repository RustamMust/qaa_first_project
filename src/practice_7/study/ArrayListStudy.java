...
public class ArrayListStudy {
    public static void main(String[] args) {
        // Стандартный пустой список (массив создаётся при первом add)
        ...
        // Список с указанной вместимостью
        ...
        // Создание списка из множества (HashSet)
        ...
        // Использование `Collections.nCopies()` для создания списка с N одинаковыми элементами
        ...
        // Двумерный ArrayList (список списков)
